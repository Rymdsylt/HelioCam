...
public class JoinerHomeActivity extends AppCompatActivity {

    private int currentFragmentIndex = 0; // Track the current fragment index
    private final int[] fragmentOrder = { // Define the order of fragments without the session button
            R.id.bottom_home,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_joiner_home);
        ...
        // Set the default fragment to JoinerHomeFragment
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.fragment_container, new JoinerHomeFragment())
                    .commit();
        }
    ...
    // Add this method to access BottomNavigationView from fragments
